...
<div>
    <h1 class="display-7 fw-bold">
        Lista De Tituladas En Etapa Productiva
    </h1>
...
<div class="row">
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success ">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">Desarrollo de Software</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 750 550">
                ...
                <hr class="border-success">
                <center><a href="<?php echo $url_base;?>/secciones/software/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">Farmacia</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 650 550">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <hr class="border-success">
                <center><a href="<?php echo $url_base;?>/secciones/farmacia/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">Entrenamiento Deportivo</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 750 550">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <hr class="border-success">
                <center><a href="<?php echo $url_base;?>/secciones/entrenamiento/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">Cocina</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 650 550">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <hr class="border-success">
                <center><a href="<?php echo $url_base;?>/secciones/cocina/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">T. Humano</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 650 550">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <center><a href="<?php echo $url_base;?>/secciones/talento/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold"> Soldadura</h5>
                <hr class="border-success">
                <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 650 550">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <hr class="border-success">
                <center><a href="<?php echo $url_base;?>/secciones/soldadura/" style="text-decoration:none"
                        class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-2 mb-3 mb-sm-4">
        <div class="card border-success">
            <div class="card-body">
                <h5 class="has-text-weight-semibold">Analisis Software</h5>
                <hr class="border-success">
                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                <hr class="border-success">
                <center><a href="#" class="btn btn-success">Ver Titulada</a></center>
            </div>
        </div>
    </div>
