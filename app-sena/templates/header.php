...
<body>
    <header>
        <div class="tabs is-centered is-boxed is-medium bg-success  ">
            ...
            <img src="https://certificadossena.net/wp-content/uploads/2022/10/logo-sena-negro-svg-2022.svg" width="70px">
            ...
            <ul>
                ...
                <li>
                    <a href="/app-sena/index.php" style="text-decoration:none">
                        <span class="icon is-big"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <li>
                    <a href="<?php echo $url_base;?>/secciones/usuarios" style="text-decoration:none">
                        <span class="icon is-big"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
                ...
                <li>
                    <a href="<?php echo $url_base;?>/cerrar.php" style="text-decoration:none">
                        <span class="icon is-small"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
